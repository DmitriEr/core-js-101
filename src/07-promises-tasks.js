...
function chainPromises(array, action) {
  ...
  // const promise = array.reduce(action, Promise.resolve());
  const promise = array.map((value) => Promise.resolve(value)).reduce(action);
  // const promise = chainPromises(promises, action);
